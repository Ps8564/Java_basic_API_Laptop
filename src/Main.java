...
public class Main {
    public static void main(String[] args) {
        ...
        laptops.add(new Laptop("Huawei", 32, 2048, "Windows", "Black"));
        laptops.add(new Laptop("Fujitsu", 16, 1024, "Windows", "Gray"));
        laptops.add(new Laptop("Xiaomi", 8, 1024, "Linux", "Gray"));
        laptops.add(new Laptop("BenQ", 16, 4096, "Windows", "Gray"));
        ...
        System.out.println("Выберать критерий для фильтрации:");
        System.out.println("1 - Объем ОЗУ (Гб 8/16/32)");
        System.out.println("2 - Объем ЖД (Гб 256/512/1024/4096)");
